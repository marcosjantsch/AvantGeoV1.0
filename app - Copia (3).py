...
def _ensure_roi_ready_for_export(
    ...
    Isso corrige principalmente o modo 'Capturar Coordenada'.
    """
    ...
    if not parsed_coordinates and modo_entrada == CAPTURE_MODE_LABEL:
...
def main():
    ...
    if apply:
        try:
            ...
            # ao aplicar novamente, qualquer download anterior deve ser invalidado
            _reset_export_state()
            ...
            # força a sidebar a ser redesenhada já com os botões inativos
            st.rerun()
